...
import { Hidden, InputLabel, Menu, MenuItem } from "@material-ui/core";
...
const Drawer1 = props => {
  ...
  if(localStorage.getItem("role")==='Patient') itemsList.push({text:"Vaccination", onClick : ()=> history.push(`/form`)})
  if(localStorage.getItem("role")==='Doctor') itemsList.push({text:"Form Approve", onClick : ()=> history.push(`/docapproval`)})
