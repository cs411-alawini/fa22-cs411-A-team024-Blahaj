...
import Form_Data from './components/Form'
import Doc_Approval from './components/Doc_Approval'
function App() {
  ...
  return (
    ...
    <Router>
      ...
      <Route path="/form" component={Form_Data} exact />
      <Route path="/docapproval" component={Doc_Approval} exact />
